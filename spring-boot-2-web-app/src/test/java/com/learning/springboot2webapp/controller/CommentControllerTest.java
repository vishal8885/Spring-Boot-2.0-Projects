package com.learning.springboot2webapp.controller;

import com.learning.springboot2webapp.model.Comment;
import com.learning.springboot2webapp.model.CommentType;
import com.learning.springboot2webapp.service.CommentService;
import com.learning.springboot2webapp.service.UserService;
...
public class CommentControllerTest {
    ...
    public void getComments_HappyPath_ShouldReturnStatus200() throws Exception {
        ...
        // When
        ResultActions resultActions = mockMvc.perform(get("/").with(user("test").roles("USER")));
